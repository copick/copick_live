    ...
    return [
        ...
        html.Div(
            children=[
                dbc.Input(
                    id="username",
                    placeholder="Please input your name (e.g., john.doe)",
                    type="text",
                ),
                dbc.Button(
                    "Download copick config file",
                    id="btn-download",
                    outline=True,
                    color="primary",
                    className="me-1",
            ...
            html.Div(
                [
                    dbc.Label(
                        "Choose results",
                        id="choose-results",
                        style={"margin-top": "35px", "margin-left": "7px"},
                    ),
                    dcc.Dropdown(
                        ["Pickathon results"],
                        "Pickathon results",
                    ...
                    dbc.Collapse(
                        ...
                        children=dcc.Loading(
                            id="loading-fig1",
                            children=[dcc.Graph(id="fig1", figure=blank_fig())],
                            type="default",
                        ),
                    ),
                    dbc.Collapse(
                                    ...
                                    [
                                        dbc.Col(
                                            [
                                                ...
                                                dbc.Label(
                                                    id="crop-label",
                                                    children="Image crop size (max 100)",
                                                    className="mt-3",
                                                ),
                                                dcc.Input(
                                                    id="crop-width",
                                        ...
                                        dbc.Col(
                                            [
                                                dcc.Loading(
                                                    id="loading-output-image-upload",
                                                    children=[html.Div(
                                                        ...
                                                        dbc.Col(
                                                            dbc.Row(
                                                                dcc.Dropdown(
                                                                    ...
                                                                    options={
                                                                        k: k
                                                                        for k in get_local_dataset()._im_dataset[
                                                                            "name"
                                                                        ]
                                                                    },
                                                                    style={
        ...
        [
            dbc.Modal(
                [
                    ...
                    dbc.ModalBody(id="modal-body-help", children=get_instructions()),
                ],
                id="modal-help",
                is_open=False,
                size="xl",
            ...
            dbc.Modal(
                [
                    ...
                    dbc.ModalBody(
                        id="modal-body-results", children=competition_results
                    ),
                ],
                id="modal-results",
                is_open=False,
            ...
            dbc.Modal(
                [
                    ...
                    dbc.ModalBody(id="modal-body-evaluation", children=get_tabs()),
                ],
                id="modal-evaluation",
                is_open=False,
                centered=True,
